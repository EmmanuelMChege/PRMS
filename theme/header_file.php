  ...
  <body>
    ...
    <div align="center">
      <table style="padding:20px 40px; cell-padding:0px 0px;" border="0" width="100%">
        ...
        <tr>
          <td align='center' style="font-size:22px; color:#21618c;"><b>XXXXXXXXXXXXX SCAN CENTRE,</b></td>
        </tr>
        <tr>
          <td align='center' style="font-size:20px; color:#21618c;">No.XX, XXXXXXXX, XXXX, XXXXXXXXX (632xxx).</td>
        </tr>
        <tr>
          <td align='center' style="font-size:20px; color:#21618c;">Reg No.: XXX/XXXXX/XXXXX</td>
        </tr>
      </table>
      <table width="90%" align="center" style=" border-collapse: collapse; " border="1" >
        ...
        <tr>
          ...
          <td style="border: solid 1px #21618c; font-size:14px; font-family: Arial;">&nbsp;&nbsp;<b>Obstetrics</b></td>
